...
int main(){
	...
	//	cout << "Twoje stringi to:" << endl << "s1: " << s1 << endl << "s2: " << s2 << endl;
		...
		table1 = Hash::crTable( s1.c_str() );
		table2 = Hash::crTable( s2.c_str() );
		...
		//		<<  "podslowo [" << beg2 << "," << beg2+dl << "] slowa s2 to: " << str2 << endl;
			...
			bool the_same_hash = Hash::equals( table1, beg1, beg1 + dl-1, table2, beg2, beg2 + dl-1 );
