...
public:
	...
	int PreOrder;
	int PostOrder;
	int conComp; // numer skladowej spojnosci, w ktorej jest dany wierzcholek, moze sie to przydac, np do silnie spojnych skladowych
...
/*	//test Minimalnego drzewa rozpinajacego - algorytmem Prima
	...
	//testowanie skladowych spojnosci grafu nieskierowanego
	cout << "Podaj, ile chcesz wierzcholkow:\t"; cin >> N;
	cout << endl << "A krawedzi:\t"; cin >> M;
