...
void scalTab( int index, int parent ){
	if( parent != index ){
		if( tab2[parent] == true && tab[index] == true ){
			tab3[parent] = true;
			tab3[index] = true;
		}
...
//		cout << endl << "ile = " << ile << endl;
	...
	/*	cout << "Stan tablicy tab po forawrdDFS:" << endl;
		REP(i,N) cout << i+1 << ":  " << tab[i] << endl;
		cout << endl;
		cout << "Stan tablicy tab2 po forawrdDFS:" << endl;
		REP(i,N) cout << i+1 << ":  " << tab2[i] << endl;
		cout << endl;
		cout << "Stan tablicy tab3 po forawrdDFS:" << endl;
		REP(i,N) cout << i+1 << ":  " << tab3[i] << endl;
		cout << endl;
