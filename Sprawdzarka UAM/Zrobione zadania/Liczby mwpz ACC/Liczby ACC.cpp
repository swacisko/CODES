...
//	for( int i=K-1; i<SIZE(beg)-1; i+=K-1 ) beg[i][0] = 1; // to jest chyba dobvre przypisanie wektora beg
	...
	// tutaj juz mam stworzone wszystkie macierze pomocnicze...
	...
	BigNum big;
	big = N;
	big -= 1; // podnosze macierz do potegi o 1 mniejszej, bo pierwsza jest macierza jedynkowa i ona sie nie wlicza...
	
	
/*	cout << "N = " << N << "   B = " << b << "   K = " << K << endl;
	cout << "beg ma postac:" << endl;
	REP(i,SIZE(beg)) WRITE(beg[i]);*/
	...
	//	cout << "Jestem w while,   big = " << flush;   big.write(); cout << endl;
	//	cout << "Macierz potegowa to:" << endl;
	//	write_full( A,B,t,T,b,K );
	//	cout << "Macierz wynikowa to:" << endl;
	//	write_full( C,D,t1,T1,b,K );
...
//	ENDL(4);
//	cout << "\tJestem za while" << endl;
//	cout << "\tTeraz macierz potegowa to:" << endl;
//	write_full( A,B,t,T,b,K );

//	cout << "\tTeraz macierz wynikowa to:" << endl;
//	write_full( C,D,t1,T1,b,K );

	
//	cout << "Jestem tylko przed val" << endl;
	LL val = 0;
...
//	cout << "JEstem po obliczeniu wartosci" << endl;
